...
<div class="center">
    <h1 style="color:#435c70">Review List</h1>
    <table id = "users">
	  <thead>
        <tr>
            <th>ID</th>
	...
	<tbody>
        ...
        <tr>
			...
			<td max-width="400px"><img src="../images/<?php echo $row['image'];?>" width="40%"></td>
  ...
  text-decoration: none;
  font-size: 16px;
  cursor: pointer;" type="submit" name="approve" id="approve" value="&#10003"/>
  </form>
  <form method="POST">
  <input type = "hidden" name  ="id" value = "<?php echo $row['id'];?>"/>
  ...
  text-decoration: none;
  font-size: 16px;
  cursor: pointer;" type="submit" name="decline" id="decline" value="X"/>
  <input style="display:inline-block;" placeholder="Reason?" type = "text" name  ="reason" value = "" required/>
    ...
    <?php
          ...
          }else {echo "<h1 style='color:red;'>" . 'No item to be reviewed!' . "</h1>";}
            ?>
			</table>
