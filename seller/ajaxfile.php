...
## Fetch records
$empQuery = "select * from order_list WHERE order_status ='Completed' and seller_id='$email' and 1 ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
...
while ($row = mysqli_fetch_assoc($empRecords)) {
    $data[] = array(
    		...
    		"totalPrice"=>number_format($row['totalPrice']*0.95, 2), 
    	);
}
