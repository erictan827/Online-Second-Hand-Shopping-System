...
<header class="header">
  ...
  <div class="btn-group">
    ...
    <table id="example" class="display" style="width:100%">
        ...
        <?php
            $email = $_SESSION['email'];
            $query = "SELECT * FROM order_list WHERE seller_id = '$email' ORDER BY time DESC";
        ...
        ?>
            ...
            <?php } else echo $row['order_status'];?>
                </td>
            </tr>
           <?php
            }
...
<?php
  if(isset($_POST['btnSubmit'])){
    if(isset($_POST['colorList'])){
      ...
      // if($value=='Completed'){$sqlb = "UPDATE order_list SET payment_status='Paid' AND order_status='$value' WHERE transaction_id='$value1';"; $resultb = mysqli_query($conn, $sqlb);}
      // else{
      $sqlaa = "UPDATE order_list SET payment_status='Paid' WHERE transaction_id='$value1' AND order_status='Completed';";
